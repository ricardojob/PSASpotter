...
def with_if_compare():   
    print(os.getgid())
        ...
        first_call = Call('name', 'hash', 5, 'os', 'getgid', '', False, 'filename', 'github.com', "high")
...
def with_if_compare():   
    if sys.platform.startswith("win"):
        ...
        usage = Usage(5, 'sys.platform', {'win'})
        first_call = Call('name', 'hash', 8, 'os', 'fork', '', False, 'filename', 'github.com', "low")
        self.assertIn(usage, checkVisitor.usages) 
        self.assertIn(first_call, checkVisitor.calls_context) 
        self.assertIn(first_call, checkVisitor.calls) 
        self.assertEqual(len(checkVisitor.usages), 1)
...
def with_if_compare():   
    ...
    if sys.platform != "win32":
        ...
        first_call = Call('name', 'hash', 5, 'os', 'getgid', '', False, 'filename', 'github.com', "high")
        second_call = Call('name', 'hash', 7, 'os', 'fork', '', False, 'filename', 'github.com', "low")
        self.assertIn(usage, checkVisitor.usages) 
        self.assertIn(first_call, checkVisitor.calls) 
...
def with_if_compare():   
    if a > 1:
        print(os.fork())
            ...
            first_call = Call('name', 'hash', 5, 'os', 'fork', '', False, 'filename', 'github.com', "high")
            self.assertNotIn(first_call, checkVisitor.calls_context) 
            self.assertIn(first_call, checkVisitor.calls) 
            self.assertEqual(len(checkVisitor.usages), 0)
            self.assertEqual(len(checkVisitor.calls_context), 0)
...
def with_if_compare():   
    try:
        ...
        pass
            ...
            checkVisitor = CheckVisitor(self.os_apis)
            checkVisitor.visit(file_compile)
            first_call = Call('name', 'hash', 5, 'os', 'fork', '', False, 'filename', 'github.com', "low")
            self.assertIn(first_call, checkVisitor.calls_context) 
            self.assertIn(first_call, checkVisitor.calls) 
            self.assertEqual(len(checkVisitor.usages), 0)
            self.assertEqual(len(checkVisitor.calls_context), 1)
...
def with_if_compare():   
    if sys.platform != "win32":
        try:
            ...
            checkVisitor.visit(file_compile)
            usage = Usage(5, 'sys.platform', {'win32'})
            first_call = Call('name', 'hash', 7, 'os', 'fork', '', False, 'filename', 'github.com', "low")
            self.assertIn(first_call, checkVisitor.calls_context) 
            self.assertIn(first_call, checkVisitor.calls) 
            self.assertIn(usage, checkVisitor.usages) 
            self.assertEqual(len(checkVisitor.usages), 1)
...
def with_if_compare():   
    try:
        ...
        print(os.fork())
            ...
            checkVisitor = CheckVisitor(self.os_apis)
            checkVisitor.visit(file_compile)
            first_call = Call('name', 'hash', 8, 'os', 'fork', '', False, 'filename', 'github.com', "high")
            self.assertNotIn(first_call, checkVisitor.calls_context) 
            self.assertIn(first_call, checkVisitor.calls) 
            self.assertEqual(len(checkVisitor.usages), 0)
            self.assertEqual(len(checkVisitor.calls_context), 0)
...
def with_if_compare(): 
    if sys.platform != "win32":  
        try:
            ...
            checkVisitor.visit(file_compile)
            usage = Usage(5, 'sys.platform', {'win32'})
            first_call = Call('name', 'hash', 9, 'os', 'fork', '', False, 'filename', 'github.com', "low")
            self.assertIn(first_call, checkVisitor.calls_context) 
            self.assertIn(first_call, checkVisitor.calls) 
            self.assertIn(usage, checkVisitor.usages) 
            self.assertEqual(len(checkVisitor.usages), 1)
...
"""
            ...
            checkVisitor = CheckVisitor(self.os_apis)
            checkVisitor.visit(file_compile)
            first_call = Call('name', 'hash', 6, 'os', 'fork', '', False, 'filename', 'github.com', "high")
            self.assertNotIn(first_call, checkVisitor.calls_context) 
            self.assertIn(first_call, checkVisitor.calls) 
            self.assertEqual(len(checkVisitor.usages), 0)
            self.assertEqual(len(checkVisitor.calls_context), 0)
...
"""
            ...
            checkVisitor = CheckVisitor(self.os_apis)
            checkVisitor.visit(file_compile)
            first_call = Call('name', 'hash', 12, 'os', 'chown', '', False, 'filename', 'github.com', "high")
            self.assertIn(first_call, checkVisitor.calls) 
            self.assertNotIn(first_call, checkVisitor.calls_context) 
            self.assertEqual(len(checkVisitor.usages), 0)
            self.assertEqual(len(checkVisitor.calls_context), 0)
